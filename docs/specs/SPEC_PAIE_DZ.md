...
**اختبار التنسيب (R4):** غياب غير مبرر 64 س · غياب مبرر 8 س · تأخّر 11,38 س · ساعات الحضور = 101,33 → السلة والنقل = 1 461,52 لكل منهما · [C] = 18 169,97 · IRG = 0 · الصافي = 18 169,96
