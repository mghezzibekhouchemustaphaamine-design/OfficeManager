...
# نظام الزوم مبني على قيمة مئوية مستمرة (self.zoom بـtab.py) لا فهرس
# بقائمة ثابتة — يسمح بأي نسبة (حتى غير المضاعفات الـ25 اللي تنتج من
# Fit to Window)، بينما الأزرار/العجلة/الاختصارات تتحرك بخطوات ثابتة
# (ZOOM_STEP) فوق هذي القيمة. الحدود والخطوة بطلب صريح.
ZOOM_MIN = 25
ZOOM_MAX = 300
ZOOM_STEP = 25
ZOOM_DEFAULT = 100
